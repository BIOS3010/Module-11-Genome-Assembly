...
`cp /storage/BIOS3010/Genome_assembly/busco_flye.sh ~/`

`cp /storage/BIOS3010/Genome_assembly/busco_canu.sh ~/`

Change name of gene set if you want using *nano*, edit the *-l insecta_odb10* to another database from the list you looked at in the step above. *If your assembly did not complete, copy one of the finished assembly that I have put in the folders /storage/BIOS3010/Genome_assembly/canu_assembly or /storage/BIOS3010/Genome_assembly/flye_assembly to your home directory and run busco on this.*
